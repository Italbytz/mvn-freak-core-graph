/*
 * @(#)ShapeAlignRight.java	1.2 01.02.2003
 *
 ...
 * shapes topmost to the coordinates (r). 
 * 
 * 
 * @author sven.luzar
 * @version 1.0
 *
 */
public class ShapeAlignRight extends AbstractActionDefault {
	 ...
	 * @param name
	 */
	public ShapeAlignRight(GPGraphpad graphpad) {
		super(graphpad);
	}
