...
public class EditCut extends AbstractActionDefault {
	 ...
	 * @param graphpad
	 */
	public EditCut(GPGraphpad graphpad) {
		super(graphpad);
	}
	 ...
	 * @param name
	 */
	public EditCut(GPGraphpad graphpad, String name) {
		super(graphpad, name);
	}
	 ...
	 * @param icon
	 */
	public EditCut(GPGraphpad graphpad, String name, Icon icon) {
