 ...
 *
 */
public class ToolBoxLine extends AbstractActionDefault {

	/**
	 * Constructor for ToolBoxLine.
	 * @param graphpad
	 */
	public ToolBoxLine(GPGraphpad graphpad) {
		super(graphpad);
	}
	...
	protected Component getToolComponent(String actionCommand) {
		JToggleButton button = graphpad.getMarqueeHandler().getButtonLine();
	...
	public void update() {
		super.update();
		graphpad.getMarqueeHandler().getButtonLine().setEnabled(isEnabled());
	}
