/*
 * @(#)FormatUnlockBendable.java	1.2 30.01.2003
 *
 ...
 *
 */
public class FormatUnlockBendable extends AbstractActionDefault {

	/**
	 * Constructor for FormatUnlockBendable.
	 */
	public FormatUnlockBendable(GPGraphpad graphpad) {
		super(graphpad);
	}
