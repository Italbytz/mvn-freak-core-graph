/*
 * @(#)ShapeAlignMiddle.java	1.2 01.02.2003
 *
 ...
 * shapes middlemost to the coordinates (r). 
 * 
 * 
 * @author sven.luzar
 * @version 1.0
 *
 */
public class ShapeAlignMiddle extends AbstractActionDefault {
