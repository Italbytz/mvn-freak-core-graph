...
public interface GraphModelProvider {
	...
	/** const to specify a decision vertex
	 *
	 *  @see #createCell(GraphModel, int, Object, Map)
	 */
	public static final int CELL_VERTEX_DECISION = 8;

	/** const to specify a start vertex
	 *
	 *  @see #createCell(GraphModel, int, Object, Map)
	 */
	public static final int CELL_VERTEX_START = 9;

	/** const to specify an end vertex
	 *
	 *  @see #createCell(GraphModel, int, Object, Map)
	 */
	public static final int CELL_VERTEX_END = 10;

	/** const to specify a split vertex
	 *
	 *  @see #createCell(GraphModel, int, Object, Map)
	 */
	public static final int CELL_VERTEX_SPLIT = 11;

	/** const to specify a join vertex
	 *
	 *  @see #createCell(GraphModel, int, Object, Map)
	 */
	public static final int CELL_VERTEX_JOIN = 12;
