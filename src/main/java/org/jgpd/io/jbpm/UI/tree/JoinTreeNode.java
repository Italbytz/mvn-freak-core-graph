 ...
 *
 */
public class JoinTreeNode extends DecisionTreeNode {

	private static ImageIcon joinIcon = ImageLoader.getImageIcon("joinIcon.gif");
	
	/**
	 * @param cell
	 */
	public JoinTreeNode(Object cell, JTree tree)
	{
		super( cell , tree );
