 ...
 *
 */
public class ForkTreeNode extends DecisionTreeNode {

	private static ImageIcon forkIcon = ImageLoader.getImageIcon("forkIcon.gif");
	
	/**
	 * @param cell
	 */
	public ForkTreeNode(Object cell, JTree tree)
	{
		super( cell, tree );
