 ...
 */
public class StartTreeNode extends ActivityTreeNode {

	private static ImageIcon startIcon =
				ImageLoader.getImageIcon("startIcon.gif");
	
	/**
	 * @param cell
	 */
	public StartTreeNode(Object cell, JTree tree)
	{
		super( cell, tree );
	...
	{
		return StartTreeNode.startIcon;
	}
}
