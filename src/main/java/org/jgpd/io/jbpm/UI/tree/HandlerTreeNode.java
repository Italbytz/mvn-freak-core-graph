 ...
 */
public class HandlerTreeNode extends JGpdTreeNode {

	private static ImageIcon handlerIcon = ImageLoader.getImageIcon("handlerIcon.gif");
	
	/**
	 * @param cell
	 */
	public HandlerTreeNode(Object cell, JTree tree)
	{
	...
	{
		// FIXME, have edit handler option
		return null;
	}
	...
	{
		return HandlerTreeNode.handlerIcon;
	}
}
