...
public class ToolBoxStart extends AbstractActionDefault {

	/**
	 * Constructor for ToolBoxStart.
	 * @param graphpad
	 */
	public ToolBoxStart(GPGraphpad graphpad) {
		super(graphpad);
	}
	...
	protected Component getToolComponent(String actionCommand) {
		JToggleButton button = graphpad.getMarqueeHandler().getButtonStart();
	...
	public void update() {
		super.update();
		graphpad.getMarqueeHandler().getButtonStart().setEnabled(isEnabled());
	}
