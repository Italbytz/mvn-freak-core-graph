...
public class ToolBoxActivity extends AbstractActionDefault {

	/**
	 * Constructor for ToolBoxActivity.
	 * @param graphpad
	 */
	public ToolBoxActivity(GPGraphpad graphpad) {
		super(graphpad);
	}
	...
	protected Component getToolComponent(String actionCommand) {
		JToggleButton button = graphpad.getMarqueeHandler().getButtonActivity();
	...
	public void update() {
		super.update();
		graphpad.getMarqueeHandler().getButtonActivity().setEnabled(isEnabled());
	}
