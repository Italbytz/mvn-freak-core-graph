...
public class ToolBoxSplit extends AbstractActionDefault {

	/**
	 * Constructor for ToolBoxSplit.
	 * @param graphpad
	 */
	public ToolBoxSplit(GPGraphpad graphpad) {
		super(graphpad);
	}
	...
	protected Component getToolComponent(String actionCommand) {
		JToggleButton button = graphpad.getMarqueeHandler().getButtonSplit();
	...
	public void update() {
		super.update();
		graphpad.getMarqueeHandler().getButtonSplit().setEnabled(isEnabled());
	}
