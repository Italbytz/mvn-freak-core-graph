...
public class ToolBoxJoin extends AbstractActionDefault {

	/**
	 * Constructor for ToolBoxJoin.
	 * @param graphpad
	 */
	public ToolBoxJoin(GPGraphpad graphpad) {
		super(graphpad);
	}
	...
	protected Component getToolComponent(String actionCommand) {
		JToggleButton button = graphpad.getMarqueeHandler().getButtonJoin();
	...
	public void update() {
		super.update();
		graphpad.getMarqueeHandler().getButtonJoin().setEnabled(isEnabled());
	}
