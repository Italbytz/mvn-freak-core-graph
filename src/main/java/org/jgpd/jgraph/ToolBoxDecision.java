...
public class ToolBoxDecision extends AbstractActionDefault {

	/**
	 * Constructor for ToolBoxDecision.
	 * @param graphpad
	 */
	public ToolBoxDecision(GPGraphpad graphpad) {
		super(graphpad);
	}
	...
	protected Component getToolComponent(String actionCommand) {
		JToggleButton button = graphpad.getMarqueeHandler().getButtonDecision();
	...
	public void update() {
		super.update();
		graphpad.getMarqueeHandler().getButtonDecision().setEnabled(isEnabled());
	}
