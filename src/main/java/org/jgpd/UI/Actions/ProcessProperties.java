 ...
 *
 */
public class ProcessProperties extends AbstractActionDefault {

	/**
	 * Constructor for FileSaveAs.
	 * @param graphpad
	 */
	public ProcessProperties(GPGraphpad graphpad) {
		super(graphpad);
	}

	public void actionPerformed(ActionEvent e) {
		getCurrentDocument().getExportModel().promptProcessProps(graphpad.getCurrentGraph());
	}
}
